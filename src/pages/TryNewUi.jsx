...
const TryNewUi = () => {
  ...
  return (
    <div className="bg-[#DAD2FF] dark:bg-purple-700 p-10 rounded-2xl my-5">
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <input
            ...
            required
            className="input input-bordered w-full md:w-80 px-4 py-3 text-lg bg-gray-100 focus:ring-2 focus:ring-purple-500 rounded-lg"
          />
